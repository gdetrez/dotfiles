...
alias cp='cp -i'
alias mv='mv -i'
alias mkdir='mkdir -m go='
alias clipboard='xsel --clipboard'
alias emacs='emacs -nw'
alias open='gvfs-open'
alias mail='emacs -f mu4e'
...
plugins=(git fabric virtualenvwrapper taskwarrior yum django)
...
# This is solarized colors for ls
